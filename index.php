...
<head>
	...
	<link rel="stylesheet" type="text/css" href="assets/css/style-v8.css">
...
<body>
    <div class="wrap-form">
            <form action="sendmail.php" class="form-contact" id="form-contact" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-block ct-subject">
                    ...
                    <div class="form-block ct-message">
                    ...
                    <div class="form-block ct-gender">
        ...
        <?php if(CF_RECAPTCHA): ?>
            <div class="form-block ct-recaptcha">
        ...
        <?php endif; ?>
                    ...
                    <div class="form-block submit-wrapper">
                            <label for="" class="tag-label"></label>
